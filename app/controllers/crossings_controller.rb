class CrossingsController < ApplicationController
  ...
  private
    ...
    def crossing_params
        params.require(:crossing).permit(:codeCross, :numOrder, :year, :status, :father, :mother, :crossWeek, :numCrossings, :goodCrossings, :badCrossings, :effective, :percentageEffective, :dateHarvest, :weekHarvest, :numSeeds, :numRepeat)
    end
end
